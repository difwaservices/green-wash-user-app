...
const List<RestaurantModel> kRestaurants = [
  RestaurantModel(
    ...
    cuisineType: 'Purified Â· Mineral',
    rating: 4.8,
    reviewCount: 1200,
    deliveryTime: '20â€“30 mins',
    distanceKm: 0.8,
    offerText: 'Flat â‚¹20 OFF above â‚¹199',
    offerAbove: 199,
    offerAmount: 20,
    heroImage: 'assets/waterimage/water1.jpg',
    topDishLabel: '20L RO Water Â· â‚¹80',
    isFeatured: true,
  ),
  RestaurantModel(
    id: 'r2',
    name: 'Crystal Clear Water',
    cuisineType: 'Alkaline Â· RO+UV',
    rating: 4.6,
    reviewCount: 950,
    deliveryTime: '25â€“40 mins',
    distanceKm: 1.5,
    offerText: 'Buy 5 Get 1 FREE',
    offerAbove: 400,
    offerAmount: 80,
    heroImage: 'assets/images/water.jpg',
    topDishLabel: '1L Mineral Bottle Â· â‚¹20',
    isFeatured: true,
  ),
  RestaurantModel(
    id: 'r3',
    name: 'Blue Springs Hub',
    cuisineType: 'Natural Â· Spring',
    rating: 4.9,
    reviewCount: 2100,
    deliveryTime: '15â€“25 mins',
    distanceKm: 0.5,
    offerText: 'New User: 50% OFF',
    offerAbove: 100,
    offerAmount: 50,
    heroImage: 'assets/waterimage/water1.jpg',
    topDishLabel: 'Premium Spring Water Â· â‚¹120',
  ),
  RestaurantModel(
    id: 'r4',
    name: 'Safe Sip Station',
    cuisineType: 'Filtered Â· Pure',
    rating: 4.2,
    reviewCount: 450,
    deliveryTime: '30â€“45 mins',
    distanceKm: 2.2,
    offerText: 'Flat â‚¹30 OFF above â‚¹299',
    offerAbove: 299,
    offerAmount: 30,
    heroImage: 'assets/images/bottal.jpg',
    topDishLabel: 'Standard 20L Jar Â· â‚¹60',
  ),
  RestaurantModel(
    id: 'r5',
    name: 'Eco Water Supply',
    cuisineType: 'Eco-Friendly Â· Safe',
    rating: 4.5,
    reviewCount: 320,
    deliveryTime: '35â€“50 mins',
    distanceKm: 3.1,
    offerText: 'Free Stand on 1st Order',
    offerAbove: 999,
    offerAmount: 300,
    heroImage: 'assets/waterimage/water1.jpg',
    topDishLabel: 'Family Combo Pack Â· â‚¹499',
  ),
];
